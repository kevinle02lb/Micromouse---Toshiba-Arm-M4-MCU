...
/* dst_inc [31:30] — destination address increment */
...
/* R_power [23:21] — arbitration interval (transfers between re-arbitrations) */
#define DMA_R_POWER_1                               ((uint32_t)0x0U << 21U)     /*!< Arbitrate after 1    */
#define DMA_R_POWER_2                               ((uint32_t)0x1U << 21U)     /*!< Arbitrate after 2    */
#define DMA_R_POWER_4                               ((uint32_t)0x2U << 21U)     /*!< Arbitrate after 4    */

/* n_minus_1 [20:4] — (total transfers - 1), max 1023 */
#define DMA_N_MINUS_1(n)                            ((uint32_t)((n) - 1U) << 4U)

/* cycle_ctrl [3:1] — transfer mode */
#define DMA_CYCLE_CTRL_INVALID                      ((uint32_t)0x0U << 1U)      /*!< Channel disabled      */
#define DMA_CYCLE_CTRL_BASIC                        ((uint32_t)0x1U << 1U)      /*!< Basic (normal)        */
#define DMA_CYCLE_CTRL_AUTO                         ((uint32_t)0x2U << 1U)      /*!< Auto-request          */
#define DMA_CYCLE_CTRL_PINGPONG                     ((uint32_t)0x3U << 1U)      /*!< Ping-pong (repeat)    */
/* ============================================================================================== */
